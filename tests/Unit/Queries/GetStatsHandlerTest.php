...
class GetStatsHandlerTest extends TestCase
{
    ...
    public function test_returns_correct_stats_with_no_attempts(): void
    {
        ...
        $this->flashcards->create('Question 1', 'Answer 1');
        $this->flashcards->create('Question 2', 'Answer 2');
        $this->flashcards->create('Question 3', 'Answer 3');
    ...
    public function test_returns_correct_stats_with_mixed_attempts(): void
    {
        ...
        $this->practiceStatuses->create($flashcard3->id, 'user-123', PracticeStatus::STATUS_CORRECT);
    ...
    public function test_returns_correct_stats_with_all_correct_attempts(): void
    {
        ...
        $this->practiceStatuses->create($flashcard1->id, 'user-123', PracticeStatus::STATUS_CORRECT);
        $this->practiceStatuses->create($flashcard2->id, 'user-123', PracticeStatus::STATUS_CORRECT);
    ...
    public function test_returns_correct_stats_with_all_incorrect_attempts(): void
    {
        ...
        $this->practiceStatuses->create($flashcard1->id, 'user-123', PracticeStatus::STATUS_INCORRECT);
        $this->practiceStatuses->create($flashcard2->id, 'user-123', PracticeStatus::STATUS_INCORRECT);
    ...
    public function test_handles_user_with_no_progress_records(): void
    {
        ...
        $this->practiceStatuses->create($flashcard->id, 'other-user', PracticeStatus::STATUS_CORRECT);
